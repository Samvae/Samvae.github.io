...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0F4C81] flex justify-center items-center p-4'>
        <form method='POST' action="https://getform.io/f/d5c78b16-3c36-42f8-b50f-b1e36f21f3cc" className='flex flex-col max-w-[600px] w-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold inline border-b-4 border-[#074276] text-white'>Contact</p>
            ...
            <button className='text-white group px-4 py-2 my-2 mx-auto flex items-center bg-[#074276] shadow-md shadow-[#040c16] hover:scale-110'>Send</button>
        </form>
    </div>
  )
}
